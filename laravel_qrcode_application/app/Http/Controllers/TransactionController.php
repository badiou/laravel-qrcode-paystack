...
class TransactionController extends AppBaseController
{
    ...
    {
        //les admins et les médérateurs peuvent voir toutes les transactions
        if(Auth::user()->role_id <3)
        {
            Flash::success('Liste de toutes les transactions effectuées.');
        ...
        {
            //ici chaque user ne peut voir que les transactions liées à son compte
            Flash::success('Liste de mes transactions.');
