...
<head>
    ...
    <title>Paiement par Qrcode | Page de création de compte</title>
...
<div class="register-box">
    <div class="register-logo">
        <a href="{{ url('/home') }}"><b>Paiement par </b>QrCode</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="Nom & prénom(s)">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" required> J'accepte les <a href="#">termes</a> du contrat 
                        </label>
                    </div>
                </div>
                <!-- /.col -->
